        ...
        <table class="bordered" id="tbl">
            <tbody>
                ...
                <tr>
                    ...
                    <td id="left" width="57%">: '.($row['indeks_berkas'] ? $row['indeks_berkas'] : "-").'</td>
                    <td id="left" width="25%"><strong>Kode</strong> : '.($row['kode'] ? $row['kode'] : "-").'</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td id="left"><strong>No. Agenda</strong> : '.($row['no_agenda'] ? $row['no_agenda'] : "-").'</td>
                </tr>
                <tr>
