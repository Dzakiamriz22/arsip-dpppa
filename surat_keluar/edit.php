...
$data = mysqli_query($koneksi, "SELECT * FROM surat_keluar WHERE id_surat_keluar='$id'");
...
<div class="card">
  <div class="card-header"><h4>Edit Surat Keluar</h4></div>
  <div class="card-body">
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="date" class="form-control" name="tanggal_keluar" value="<?= $row['tanggal_keluar'] ?>" required>
      </div>
      <div class="mb-3">
